-- Completion-A: extend test cleanup for launch-phase tables
-- (setup, receipts, import/export, comments) so RESTRICT FKs do not block teardown.
...
begin
  ...
  foreach v_id in array v_ids loop
    ...
    -- Launch phase (before expenses / households)
    ...
    -- UX-C lightweight tables (if present)
